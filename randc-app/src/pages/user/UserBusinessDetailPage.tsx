...
import FancyPromoCard  from '../../pages/marketplace/FancyPromoCard';
...
import ReviewsSection from '../../pages/marketplace/ReviewsSection';
...
const UserBusinessDetailPage: React.FC = () => {
  ...
  // ─────────────────────────────────────────────────────────
  // ADDING WAVE DIVIDERS + BACKGROUND GRADIENT
  // ─────────────────────────────────────────────────────────
  return (
    <section className="relative w-full min-h-screen overflow-hidden text-gray-800">
      ...
      {/* Sticky top bar */}
      <div className="sticky top-0 z-10 bg-yellow-200 text-yellow-800 p-2 font-semibold shadow-sm flex justify-between items-center mb-2">
        <span className="text-sm">
          Manage your appointments or book now with {tenant.name}!
        </span>
        <button
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-7xl mx-auto mt-6 px-4 grid grid-cols-1 md:grid-cols-[2fr_1fr] gap-6 pb-20">
          {/* Left Column */}
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="text-right">
                          ...
                          <Link
                            to={`/seeker/dashboard/log-user/booking-manager?tenantId=${tenant._id}&serviceId=${srv._id}`}
                            className={clsx(
      ...
      {/* Lightbox / Popup for SERVICE images */}
...
export default UserBusinessDetailPage;
