...
const DeleteModal = ({ isOpen, onClose, onDeleteConfirm }) => {
  const handleDeleteConfirm = () => {
    onDeleteConfirm(); // Immediately call onDeleteConfirm passed from the parent
    onClose(); // Close the DeleteModal
  };
      ...
      <div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex justify-center items-center">
        <div className="bg-white p-8 rounded-lg shadow-xl max-w-xl mx-auto w-full relative">
          ...
          <div className="p-8 rounded-lg max-w-lg w-full text-center mb-16">
            ...
            <h3 className="text-2xl font-semibold mb-8">Delete company?</h3>
