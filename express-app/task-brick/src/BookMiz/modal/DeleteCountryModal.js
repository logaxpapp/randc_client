...
const DeleteCountryModal = ({ isOpen, onClose, onDelete }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex justify-center items-center">
      ...
      <div className=" p-8 rounded-lg  max-w-lg  w-full text-center mb-16">
        <FontAwesomeIcon icon={faTrashAlt} size="2x" className="text-gray-400 mx-auto mb-4" />
        <h3 className="text-2xl font-semibold mb-8">Delete country?</h3>
        <p className="mb-20 text-sm  text-gray-500">The country with all its states and cities will be deleted</p>
